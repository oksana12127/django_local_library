...
#     genre__name__icontains='fiction')  # Will match on: Fiction, Science fiction, non-fiction etc.
...
class Book(models.Model):
    ...
    date = models.ForeignKey('DateWriting', related_name='books', on_delete=models.SET_NULL, null=True)
...
class BookInstance(models.Model):
    ...
    class Meta:
        ordering = ["due_back"]
        permissions = (("can_mark_returned", "Set book as returned"), ("can_edit", "can edit"))
...
class Language(models.Model):
    ...
    def __str__(self):
        ...
        String for representing the Model object.
        """
        return '%s' % (self.langauge_book)


class DateWriting(models.Model):
